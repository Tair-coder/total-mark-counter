...
const ratignMark = {
  ...
  bad: [[49, "0.00", "F", "Неудовлетворительно"]],
};
function TotalMark() {
    ...
    <Card className={styles.cart}>
      ...
      <ul className={styles.list}>
        ...
        <li>
          ...
          <h2 className={styles.markInOtherWays}>
            {totalMark.digitalEquivalent}
          </h2>
        </li>
      </ul>
      <Button
        buttonName={"Подсчитать снова"}
        onClick={returnMainBlockHandler}
      />
    </Card>
  );
}
